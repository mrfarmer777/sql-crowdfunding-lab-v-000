...
"SELECT projects.title, SUM(pledges.amount)-projects.funding_goal FROM project INNER JOIN pledges ON projects.id=pledges.project_id WHERE projects.funding_goal< SUM(pledges.amount)"
end
