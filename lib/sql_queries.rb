...
"SELECT project.title, SUM(pledges.amount)-project.funding_goal FROM project INNER JOIN pledges ON projects.id=pledges.project_id WHERE project.funding_goal< SUM(pledges.amount)"
end
